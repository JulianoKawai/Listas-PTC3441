...
( char_T * ) ( & rtB . mo2rcpgszm [ 0 ] ) , 0 , 0 , 18 } , { ( char_T * ) ( &
rtDW . bhsacjpwps . LoggedData [ 0 ] ) , 11 , 0 , 8 } } ; static
DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . g ) , 0 ,
0 , 23 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
