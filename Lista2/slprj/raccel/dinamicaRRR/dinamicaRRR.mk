...
MODEL               = dinamicaRRR
MODULES             = rt_logging.c dinamicaRRR.c dinamicaRRR_capi.c dinamicaRRR_data.c dinamicaRRR_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE            = dinamicaRRR.mk
MATLAB_ROOT         = D:/Program Files/MATLAB
ALT_MATLAB_ROOT     = D:/PROGRA~1/MATLAB
MATLAB_BIN          = D:/Program Files/MATLAB/bin
ALT_MATLAB_BIN      = D:/PROGRA~1/MATLAB/bin
MASTER_ANCHOR_DIR   = 
START_DIR           = D:/BAGOFH~1/COMPUT~1/Projetos/LISTAD~1/Lista2
...
PCMATLABROOT        = D:\\Program Files\\MATLAB
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/dinamicaRRR \
...
rt_logging.obj : D:\Program\ Files\MATLAB\rtw\c\src/rt_logging.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src/rt_logging.c

raccel_main_new.obj : D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_main_new.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_main_new.c

raccel_sup.obj : D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_sup.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_sup.c

raccel_mat.obj : D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_mat.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\raccel/raccel_mat.c

simulink_solver_api.obj : D:\Program\ Files\MATLAB\simulink\include/simulink_solver_api.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\simulink\include/simulink_solver_api.c

raccel_utils.obj : D:\Program\ Files\MATLAB\rtw\c\src\rapid/raccel_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\rapid/raccel_utils.c

common_utils.obj : D:\Program\ Files\MATLAB\rtw\c\src\rapid/common_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\rapid/common_utils.c

ext_svr.obj : D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/ext_svr.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/ext_svr.c

updown.obj : D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/updown.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/updown.c

ext_work.obj : D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/ext_work.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/ext_work.c

rtiostream_interface.obj : D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/rtiostream_interface.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\rtw\c\src\ext_mode\common/rtiostream_interface.c

rtiostream_tcpip.obj : D:\Program\ Files\MATLAB\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c

rtiostream_utils.obj : D:\Program\ Files\MATLAB\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Program\ Files\MATLAB\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
